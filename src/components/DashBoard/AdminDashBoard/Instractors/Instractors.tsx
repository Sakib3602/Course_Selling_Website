...
const Instructors = () => {
  ...
  const mutationUp = useMutation({
    ...
    onSuccess: () => {
    refetch();
      toast.success("Role Demoted successfully!", {
        position: "top-right",
        autoClose: 3000,
              ...
              <tr key={user._id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-right">
                  <button
                    ...
                    className="inline-flex items-center px-3 py-1.5 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none"
                  >
                    Demote
                  </button>
                </td>
