        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Create a new course entry for the platform.
            </p>
          </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-3">
                  {courseData.curriculum.map((item: string, index: number) => (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        type="number"
                        name="priceUSD"
                        defaultValue={courseData.priceUSD}
                        onChange={handleChange}
                        placeholder="79.99"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="priceBDT"
                        required
                        defaultValue={courseData.priceBDT}
                        onChange={handleChange}
                        placeholder="8990"
                        className="w-full pl-8 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
                      />
