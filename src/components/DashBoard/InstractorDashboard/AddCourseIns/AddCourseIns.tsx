                    ...
                    <div className="relative w-full h-48 bg-gray-100 rounded-lg overflow-hidden border border-gray-200 group">
                      ...
                      <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                        <button
                          type="button"
                          onClick={removeImage}
                          className="bg-white text-red-600 px-3 py-2 rounded-lg shadow-lg hover:bg-red-50 transition-colors transform hover:scale-105 flex items-center gap-2"
                        >
                          <Trash2 size={18} />
                          <span className="text-sm font-medium">Remove</span>
                        </button>
                        <label className="bg-white text-indigo-600 px-3 py-2 rounded-lg shadow-lg hover:bg-indigo-50 transition-colors transform hover:scale-105 flex items-center gap-2 cursor-pointer">
                          <Upload size={18} />
