      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center j  gap-8 w-full">
        ...
        <div className="text-justify lg:text-left space-y-12 lg:space-y-20 text-white lg:w-[40%]">
          ...
          <p className="text-lg text-justify leading-relaxed">
            ...
            work, and you have to inspire teammates and customers.
          </p>
         <div className="flex gap-6">
           <button className="border border-[#D22F2F] hover:bg-white hover:text-black text-white px-6 py-3 rounded-lg hover:rounded-2xl transition-all duration-300 ease-in-out">
            Contact Now
          </button>
          <button className="bg-[#D22F2F] hover:bg-white  hover:text-black text-white px-6 py-3 rounded-lg hover:rounded-2xl transition-all duration-300 ease-in-out">
            Contact Now
          </button>
         </div>
        </div>
